  ...
  module Test
    class Run
      class Isolate
        ...
        def self.configure(receiver, session: nil, isolate: nil, attr_name: nil)
          attr_name ||= :isolate
        ...
        def start
          ...
          process_id = fork do
            ...
            session.telemetry.register(telemetry_sink)
